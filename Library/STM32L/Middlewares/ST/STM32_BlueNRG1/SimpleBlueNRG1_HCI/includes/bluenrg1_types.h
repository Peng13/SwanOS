...
extern const hci_le_meta_events_table_type hci_le_meta_events_table[9];
extern const hci_vendor_specific_events_table_type hci_vendor_specific_events_table[42];
#include <stdint.h>
