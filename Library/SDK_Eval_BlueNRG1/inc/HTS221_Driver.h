...
#define HTS221_ReadReg(RegAddr, NumByteToRead, Data)    HAL_ReadReg(RegAddr, NumByteToRead, Data)

// the user must redefine the proper HTS221_WriteReg
#define HTS221_WriteReg(RegAddr, NumByteToWrite, Data)  HAL_WriteReg(RegAddr, NumByteToWrite, Data)
